...
# MAGIC %sql
# MAGIC SELECT organization_name, repository_account, repository_name, l1_type, l2_type, l3_type, tags_array, is_current, valid_from_date, valid_to_date, dbx_created_at_datetime_utc, dbx_updated_at_datetime_utc
# MAGIC FROM silver_db.s_company
# MAGIC ORDER BY organization_name ASC, valid_from_date ASC;
...
# %sql
# SELECT organization_name, repository_account, repository_name, l1_type, l2_type, l3_type, tags_array, is_current, valid_from_date, valid_to_date, dbx_created_at_datetime_utc, dbx_updated_at_datetime_utc
# FROM silver_db.s_company
# WHERE organization_name = 'Airbyte'
...
# MAGIC SELECT organization_name, repository_account, repository_name, l1_type, l2_type, l3_type, tags_array, is_current, valid_from_date, valid_to_date, dbx_created_at_datetime_utc, dbx_updated_at_datetime_utc
# MAGIC FROM silver_db.s_company
# MAGIC WHERE organization_name IN ('Airflow', 'Dremio')
# MAGIC ORDER BY organization_name ASC, valid_from_date ASC;
...
# SELECT organization_name, repository_account, repository_name, l1_type, l2_type, l3_type, tags_array, is_current, valid_from_date, valid_to_date, dbx_created_at_datetime_utc, dbx_updated_at_datetime_utc
# FROM silver_db.s_company
# WHERE organization_name = 'Airflow'
# ORDER BY valid_from_date ASC;
...
# SELECT organization_name, repository_account, repository_name, l1_type, l2_type, l3_type, tags_array, is_current, valid_from_date, valid_to_date, dbx_created_at_datetime_utc, dbx_updated_at_datetime_utc
# FROM silver_db.s_company
# WHERE organization_name = 'Dremio'
# ORDER BY valid_from_date ASC;
