...
# MAGIC ORDER BY created_at_datetime_utc ASC;
...
# MAGIC SELECT *
# MAGIC FROM silver_db.s_github
# MAGIC WHERE valid_date = '2022-09-30'
# MAGIC ORDER BY created_at_datetime_utc ASC;
...
# MAGIC SELECT *
# MAGIC FROM silver_db.s_github
# MAGIC WHERE _pk IN (19541174571, 19541183344, 23179896442, 23179912111, 23753918452, 23753920556)
# MAGIC ORDER BY created_at_datetime_utc ASC;
